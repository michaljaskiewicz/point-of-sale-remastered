...
import pl.javamentor.pointofsaleremastered.pointofsale.domain.model.command.AddProductToReceipt;
import pl.javamentor.pointofsaleremastered.pointofsale.domain.model.command.CloseReceipt;
